...
exports.default = function (opts) {
    ...
    return (0, _through2.default)({
            ...
            if (opts) {
                for (var key in opts) {
                    if (_commands2.default.hasOwnProperty(key) && opts[key] === true) {
                        ...
                        log('Warning!.', 'Command `' + _gulpUtil2.default.colors.yellow(key) + '` not supported by gulp-yarn.');
        ...
        if (skipInstall()) {
            log('Skipping yarn.', 'Run `' + _gulpUtil2.default.colors.yellow(formatCommands(toRun)) + '` manually');
            return callback();
        }
...
function log() {
    ...
    _gulpUtil2.default.log.apply(_gulpUtil2.default, _toConsumableArray([].slice.call(arguments)));
}
